...
db.datos_personales.insertOne({ nombre_apellido: "Jesica Brenda Basile", residencia: "Gualeguaychú, Entre Ríos - Argentina", correo_electronico: "jessbrenba@gmail.com", linkedin: "Linkedin", portaflio: "GitHub", skills: "Contadora Publica | Data Analytics | Power Bi | SQLServer | MySQL | Docente universitaria"})
db.experiencia_profesional.insertOne({ empresa: "Agro Gestion del Litoral S.A.", puesto: "Responsable Finanzas", fecha_inicio: ISODate("2014-06-03T08:00:00Z"), fecha_finalizacion: "Actualidad", estado: "Activo", descripcion: "Conciliaciones bancarias, Conciliaciones cta cte proveedores bimonetarios ($ y usd), Caja chica, Arqueos, Cheques, e-cheqs, Tarjetas business, Facturación compras, Liquidaciones CyO, Pagos con retenciones bimonetarios y Emisión informes financieros cashflow"})

db.formacion_academica.insertMany([{ fecha_inicio: ISODate("2022-03-01T00:00:00Z"), fecha_finalizacion: "Actualidad", estado: "En elaboración de tesis", institucion: "UBP", titulo: "Maestría en Dirección y Gestión de RRHH"},
...
db.certificaciones.insertMany([{fecha_inicio: ISODate("2024-08-19T00:00:00Z"), fecha_finalizacion: ISODate("2024-09-16T00:00:00Z"), estado: "Finalizado", institucion: "EducacionIT", titulo: "Introduccion a MongoDB"},
...
db.formacion_docente.insertMany([{ fecha_inicio: ISODate("2023-03-01T00:00:00Z"),  fecha_finalizacion: ISODate("2023-12-15T00:00:00Z"), estado: "En elaboración de Trabajo Final", institucion: "UBA", titulo: "Especialización en Tecnología Educativa", descripcion: "En elaboración de Trabajo Final"},
...
db.experiencia_docente.insertMany([{ institucion: "UCSF", cargo: "Docente Universitaria en Ciencias Económicas", asignatura: "Seminario de Investigación Científica - 5° Año", fecha_inicio: ISODate("2024-03-01T00:00:00Z"), fecha_finalizacion: "En Actividad"},
