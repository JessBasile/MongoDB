...
Se diseñó una base de datos no relacional que contiene el curriculum vitae de la autora hasta la fecha, la cual se ejecuta exitosamente en el motor de MongoDB. El código fue adaptado para interactuar con la base de datos y hacer correr comandos utilizandos con MongoDB Shell en combinación con JavaScript.
